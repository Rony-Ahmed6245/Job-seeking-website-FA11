    ...
    return (
        <div className="space-y-3 py-5 max-w-screen-xl	 mx-auto md:px-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 pt-8 gap-4">
                ...
                <p className="text-justify text-gray-400"> <span className="text-5xl text-green-400 font-bold">“</span> "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa.”</p>
                ...
                <p className="text-justify text-gray-400"> <span className="text-5xl text-green-400 font-bold">“</span> Begin by ensuring that you fully understand the client's request. Ask for detailed information, including the type of content or services they need, their specific requirements, deadlines, and any other relevant details.</p>
                    <div className="flex justify-start items-center gap-5">
                        <img className="w-[50px] border rounded-full" src={img} alt="" />
                        <div>
                ...
                <div className="p-4 shadow rounded bg-white space-y-3 hover:shadow-xl transition-all">
                <p className="text-justify text-gray-400 "> <span className="text-5xl text-green-400 font-bold">“</span> Discuss the terms of the engagement, including pricing, payment terms, milestones, and any contractual agreements. It's crucial to have a clear understanding of expectations and ensure both parties are in agreement.</p>
                    <div className="flex justify-start items-center gap-5">
                        <img className="w-[50px] border rounded-full" src={img} alt="" />
                        <div>
