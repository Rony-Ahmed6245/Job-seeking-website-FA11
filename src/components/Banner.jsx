                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 justify-between items-center'>
                    <div className='space-y-5'>
                        ...
                        <div className='flex rounded-full '>
                            ...
                            <div className=' bg-green-500  hover:drop-shadow-2xl  shadow-white text-white md:py-4 py-2 outline-none px-4 rounded-r-md flex justify-center items-center' type="button" ><BsFillSendFill className=' text-[20px]'></BsFillSendFill></div>
                        </div>
